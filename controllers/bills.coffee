...
monthlyGenQuery = exports.genQuery = (dateObj) ->
    d = convertDate(dateObj)
    query =
        orderTime:
...
monthlyQueryBill = exports.monthlyQueryBill = (dateObj, cb) ->
...
monthlyReportApi = exports.monthlyReportApi = (req, res) ->
    r = req.params
    date = "#{r.year}-#{r.month}-#{r.day}"
    convertedDate = convertDate(new Date(date))

    monthlyQueryBill date, (bills) ->
        monthlyCalculate bills, (cBills) ->
            res.json cBills

monthlyDishCount = exports.monthlyDishCount = (req, res) ->
    r = req.params
    date = "#{r.year}-#{r.month}-#{r.day}"
...
monthly_statement = exports.monthly_statement = (req, res) ->
    res.render 'admin/monthly_statement'
